...
### 8.Number of cancelled rides by unbanned users

```sql

-- 1. Create and populate the 'users' table
...
-- 2. Create and populate the 'trips' table
...
INSERT INTO trips (id, client_id, driver_id, city_id, status, request_at) VALUES
    ...
    (2, 2, 11, 1, 'cancelled_by_driver', '2026-10-01'),
    (3, 3, 12, 6, 'completed', '2026-10-01'),
    (4, 4, 13, 6, 'cancelled_by_client', '2026-10-01'),
    (5, 1, 10, 1, 'completed', '2026-10-02'),
    (6, 2, 11, 6, 'completed', '2026-10-02'),
    (7, 3, 12, 6, 'completed', '2026-10-02'),
    (8, 2, 12, 12, 'completed', '2026-10-03'),
    (9, 3, 10, 12, 'completed', '2026-10-03'),
    (10, 4, 13, 12, 'cancelled_by_driver', '2026-10-03');
