...
**[entries_floor_and_resources.sql](./entries_floor_and_resources.sql)** | Visitor Floor & Resource Usage AnalysisCTEs (WITH), Window Functions (RANK()), String Aggregation (STRING_AGG), Aggregations (COUNT)
